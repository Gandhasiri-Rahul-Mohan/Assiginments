# -*- coding: utf-8 -*-
"""
Created on Fri Dec 23 19:36:31 2022
...
import numpy as np
import pandas as pd
df = pd.read_csv("D:\\DS\\books\\ASSIGNMENTS\\Multi Linear Regression\\ToyotaCorolla.csv", encoding='latin1')
df
df.shape
list(df)
df.isnull().sum() 
...
df1=df1.rename({'Age_08_04':'Age','Quarterly_Tax':'QT','cc':'CC'},axis=1)
df1
df1.corr()
df1.corr().to_csv("MLR.csv")
# Age has high negative correlation with Price
...
# Here Model 5 where Y=df1[["Price"]] and X = df1[["Age","Weight","KM","HP","QT"]]
# since its r2 for train and test are 0.86117 and 0.86116 respectively, P value of   
